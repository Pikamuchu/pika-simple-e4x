...
function createPublicMethodsIfNoDataConfict(obj) {
  ...
  if (!obj.get) {
    obj.get = obj._get || doNothing;
  }
  if (!obj.set) {
    obj.set = obj._set || doNothing;
  }
  if (!obj.appendChild) {
    obj.appendChild = obj._appendChild || doNothing;
  }
  if (!obj.attribute) {
    obj.attribute = obj._attribute || doNothing;
  }
  if (!obj.length) {
    obj.length = obj._length || doNothing;
  }
  if (!obj.name) {
    obj.name = obj._name || doNothing;
  }
  if (!obj.text) {
    obj.text = obj._text || doNothing;
  }
  if (!obj.children) {
    obj.children = obj._children || doNothing;
  }
  if (!obj.elements) {
    obj.elements = obj._elements || doNothing;
  }
  if (!obj.elementsNames) {
    obj.elementsNames = obj._elementsNames || doNothing;
  }
  if (!obj.attributesNames) {
    obj.attributesNames = obj._attributesNames || doNothing;
  }
}
